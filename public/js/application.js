...
(function() {
  ...
  require(["jquery", "d3", "pubsub", "7/svg_drawer", "common", "imagesPreloader"], function($, d3, PubSub, svg_drawer, common, imagesPreloader) {
   
    return $(function() {
      svg_drawer();
      require(["7/prenoms_list", "prenoms_dataset"], function(prenoms_list, prenoms_dataset) {
