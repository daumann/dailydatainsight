...
function generateVisualization(url,coordinate_x,coordinate_y,dateStartTimeline,countryName,customZoom){
    ...
    var bakedLongitude = new Array();
        ...
        d3.tsv('../misc/personData.csv', function (error, personData) {
...
//console.debug("adding longitude: "+longitudeToPush);
        ...
        function doRest() {
            ...
            if (params.datapoint!==undefined){
              //  console.debug(params.datapoint)
...
$( document ).ready(function() {
    ...
    generateVisualization("data/datapoints.json", 28, -9, new Date(-1000, 10, 06), "Hover/ click items to query information", 2);
